...
if [[ $1 == "--run" ]]; then
    ...
    /usr/local/share/aquagpusph/examples/3D/spheric_testcase2_dambreak/cMake/../Create.py
    /usr/local/bin/AQUAgpusph -i Main.xml
elif [[ $1 == "--plot" ]]; then
    python /usr/local/share/aquagpusph/examples/3D/spheric_testcase2_dambreak/cMake/../plot_$2.py
else
    echo ""
