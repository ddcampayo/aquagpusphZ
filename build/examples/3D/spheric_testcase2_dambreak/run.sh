...
if [[ $1 == "--run" ]]; then
    ...
    /home/daniel/aquagpusph/build/examples/3D/spheric_testcase2_dambreak/Create.py
    /home/daniel/aquagpusph/build/bin/AQUAgpusph -i Main.xml
elif [[ $1 == "--plot" ]]; then
    python /home/daniel/aquagpusph/build/examples/3D/spheric_testcase2_dambreak/plot_$2.py
else
    echo ""
