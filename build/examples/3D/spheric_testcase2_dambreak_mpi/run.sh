...
if [[ $1 == "--run" ]]; then
    ...
    /home/daniel/aquagpusph/build/examples/3D/spheric_testcase2_dambreak_mpi/Create.py
    mpirun --hostfile hostfile /home/daniel/aquagpusph/build/bin/AQUAgpusph -i Main.xml
elif [[ $1 == "--plot" ]]; then
    python /home/daniel/aquagpusph/build/examples/3D/spheric_testcase2_dambreak_mpi/plot_$2.py
else
    echo ""
