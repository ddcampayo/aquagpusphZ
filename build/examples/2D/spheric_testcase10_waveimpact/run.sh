...
if [[ $1 == "--run" ]]; then
    ...
    /home/daniel/aquagpusph/build/examples/2D/spheric_testcase10_waveimpact/Create.py
    /home/daniel/aquagpusph/build/bin/AQUAgpusph2D -i Main.xml
elif [[ $1 == "--plot" ]]; then
    python /home/daniel/aquagpusph/build/examples/2D/spheric_testcase10_waveimpact/plot_$2.py
else
    echo ""
