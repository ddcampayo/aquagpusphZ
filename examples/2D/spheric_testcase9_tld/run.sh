...
if [[ $1 == "--run" ]]; then
    ...
    /home/daniel/aquagpusph.gcc/examples/2D/spheric_testcase9_tld/Create.py
    /home/daniel/aquagpusph.gcc/bin/AQUAgpusph2D -i particlesPacking.xml
    rm -f FreeSurface.*.vtu
    rm -f FreeSurface.pvd
    ...
    python /home/daniel/aquagpusph.gcc/examples/2D/spheric_testcase9_tld/plot_$2.py
else
    echo ""
