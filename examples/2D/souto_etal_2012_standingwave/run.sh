...
if [[ $1 == "--run" ]]; then
    ...
    rm -f EnergyKin.dat
    /home/daniel/aquagpusph.gcc/examples/2D/souto_etal_2012_standingwave/Create.py
    /home/daniel/aquagpusph.gcc/bin/AQUAgpusph2D -i Main.xml
elif [[ $1 == "--plot" ]]; then
    python /home/daniel/aquagpusph.gcc/examples/2D/souto_etal_2012_standingwave/plot_$2.py
else
    echo ""
