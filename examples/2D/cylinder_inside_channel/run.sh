...
if [[ $1 == "--run" ]]; then
    ...
    /home/daniel/aquagpusph.gcc/examples/2D/cylinder_inside_channel/Create.py
    /home/daniel/aquagpusph.gcc/bin/AQUAgpusph2D -i Main.xml
elif [[ $1 == "--plot" ]]; then
    python /home/daniel/aquagpusph.gcc/examples/2D/cylinder_inside_channel/plot_$2.py
else
    echo ""
